...
K-Means 算法
    ...
    定义:
        ...
        ·K-Means 是发现给定数据集的 K 个簇的聚类算法, 之所以称之为 K-均值 是因为它可以发现 K 个不同的簇, 
          且每个簇的中心采用簇中所含值的均值计算而成.
...
if __name__ == '__main__':
    dataMat = mat(loadDataSet('../data/ch10/testSet.txt'))
    ...
    # 地图点聚类
    dataMat3 = mat(loadDataSet('../data/ch10/testSet2.txt'))
    centList, myNewAssments = biKmeans(dataMat3, 3)
    print('centList: \n', centList, '\n')
    fileName = '../data/ch10/places.txt'
    imgName = '../data/ch10/Portland.png'
